...
url = 'https://ccb-compute.cs.uni-saarland.de/mirmaster/about/'
response = requests.get(url)
html = response.text
img_urls = re.findall(r"\w+.jpg",html)
print img_urls
for img_url in img_urls:
    img_response=requests.get("https://ccb-compute.cs.uni-saarland.de/mirmaster/about/%s" %img_url)
    print(img_url)
    img_data=img_response.content #二进制信息
